   ...
   <body id="page-top" class="hold-transition layout-top-nav">
    <div class="wrapper">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="{{ asset('startbootstrap') }}/assets/img/navbar-logo.svg" alt="..." /></a>
...
<!-- Bootstrap core JS-->
 ...
 <!-- Contact form JS-->
 <script src="{{ asset('startbootstrap') }}/assets/mail/jqBootstrapValidation.js"></script>
 <script src="{{ asset('startbootstrap') }}/assets/mail/contact_me.js"></script>
 <!-- Core theme JS-->
