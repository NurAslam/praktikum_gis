...
<div class="row justify-content-center">
    <div class="col-md-6">
        ...
        <div class="card">
            ...
            <form method="POST" action="<?php echo e(route('outlets.update', $outlet)); ?>" accept-charset="UTF-8">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="tipe" type="text" class="form-control<?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" name="tipe" value="<?php echo e(old('name', $outlet->tipe)); ?>" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\praktikum_gis\resources\views/outlets/edit.blade.php ENDPATH**/ ?>